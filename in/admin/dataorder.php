...
$queri="Select * From transaksi" ;  //menampikan SEMUA data dari tabel siswa
...
?>    
    ...
    <td><center><a class="tombol" href="editTransaksi.php?id=<?php echo $data['id_transaksi']; ?>">Edit</a><a class="tombol" href ="hapusTransaksi.php?id=<?php echo $data['id_transaksi']; ?>" onclick="return confirm('Hapus No Order <?php echo $data['no_order']; ?>?');">Hapus</a></center></td>
